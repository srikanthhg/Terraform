module "vpn" {
    ...
    sg_name = "vpn"
    # sg_ingress_rules = var.momngodb_sg_ingress_rules
}
...
#openvpn accepting connections from my pc

resource "aws_security_group_rule" "mongodb_vpn_home" {
...
#rabbitmq accepting connections from payments and vpn
...
#catalogue accepting connections from web, cart and vpn
...
# user accepting connections from web and and vpn
